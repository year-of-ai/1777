...
- empirical method
excerpt: In 1777, Antoine Lavoisier published "Mémoire sur la combustion en général" ("On Combustion in General"), launching the first systematic quantitative attack on phlogiston theory—the prevailing (and incorrect) explanation of combustion and oxidation that had dominated chemistry for a century.…
preview: "/images/previews/science.svg"
permalink: "/news/science/lavoisier-oxygen-theory/"
featured: true
---
...
The same year that Lavoisier was overturning chemistry's foundational assumptions, James Watt was deploying engines that applied thermodynamic principles Lavoisier was simultaneously formalizing (see [James Watt's Steam Engine]({{ '/news/economics/james-watt-steam-engine/' | relative_url }})), and American colonists were fighting for independence at Saratoga (see [Battles of Saratoga]({{ '/news/military/battles-of-saratoga/' | relative_url }}))—a convergence that makes 1777 one of the most consequential single years of the 18th century.

## Sources

- [Antoine Lavoisier - Wikipedia](https://en.wikipedia.org/wiki/Antoine_Lavoisier)
- [Antoine Lavoisier - Science History Institute](https://www.sciencehistory.org/education/scientific-biographies/antoine-laurent-lavoisier/)
- [Marie-Anne Paulze Lavoisier - Wikipedia](https://en.wikipedia.org/wiki/Marie-Anne_Paulze_Lavoisier)
- [Phlogiston theory - Britannica](https://www.britannica.com/science/phlogiston)
- [Oxygen - Britannica](https://www.britannica.com/science/oxygen)
