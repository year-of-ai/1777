...
The same year that Lavoisier was overturning chemistry's foundational assumptions, James Watt was deploying engines that applied thermodynamic principles Lavoisier was simultaneously formalizing (see [James Watt's Steam Engine](../economics/james-watt-steam-engine.md)), and American colonists were fighting for independence at Saratoga (see [Battles of Saratoga](../military/battles-of-saratoga.md))—a convergence that makes 1777 one of the most consequential single years of the 18th century.

<!-- BEGIN GENERATED: crossrefs — maintained by build-structure; do not edit by hand -->
## Related

- [James Watt's Steam Engine](../economics/james-watt-steam-engine.md) — parallel revolution in applied thermodynamics occurring in the same year
